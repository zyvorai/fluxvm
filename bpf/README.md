...
| `fluxvm_service.bpf.c` | Service Fabric TC (BPF schema 4 / gen 7): Maglev VIP, NAT/DSR, SNAT, affinity, EDT, flows, identity/L7 policy, HA queue |
| `fluxvm_service_xdp.bpf.c` | Optional north-south XDP service acceleration (reuses TC service pinmaps) |
| `fluxvm_service_connect.bpf.c` | Opt-in cgroup/connect4 VIP rewrite (shares host maps; fail-open to TC/XDP) |
