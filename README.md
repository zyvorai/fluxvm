...
- [Service Fabric (Maglev VIP LB schema v4)](docs/service-fabric.md)
...
- **Service Fabric** — node-local Maglev VIP load balancing (**schema v4**): dual-stack NAT/DSR/SNAT, forward conntrack affinity, Ready/Draining/Unhealthy + TCP health, VIP advertisement snapshot, restricted conntrack export/import, per-service EDT, FluxScope flows, optional host-routing. Fabric owns leases/fan-out. See [docs/service-fabric.md](docs/service-fabric.md).
