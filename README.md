...
- [Service Fabric (Maglev VIP LB schema v5)](docs/service-fabric.md)
...
- **Service Fabric** — node-local Maglev VIP load balancing (**schema v4 ABI / v5 HA**): dual-stack NAT/DSR/SNAT, forward conntrack affinity, Ready/Draining/Unhealthy + TCP health, VIP advertisement snapshot, incremental intent reconcile, bounded HA delta journal, per-service EDT, FluxScope flows, optional host-routing. Fabric owns leases/fan-out/replication. See [docs/service-fabric.md](docs/service-fabric.md).
