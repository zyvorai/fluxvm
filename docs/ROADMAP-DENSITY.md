...
| **3** | linux-loader + platform (e820/MP/CMOS/PIT/CPUID) + virtio-blk root + userspace; then snapshots / warm pools / density benches | **In progress** — lab reaches `/bin/sh` userspace |
