...
| **2** | Real virtio-blk MMIO + rootfs attach (`cfg.disk`); cmdline virtio_mmio.device slots | **In progress** — blk I/O wired |
| **3** | Snapshots / warm pools / density marketing numbers; linux-loader boot_params | Not started |
