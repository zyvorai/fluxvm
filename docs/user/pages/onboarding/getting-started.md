...
2. Optional: `fluxctl serve` and check `http://127.0.0.1:7788/readyz`
3. `fluxctl create --spec examples/qemu.json`
4. `fluxctl exec <id> -- echo hello` (Linux) or `fluxctl qga …` (Windows)
5. `fluxctl delete <id>` or rely on `ttl_seconds`
