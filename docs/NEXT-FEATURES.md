...
Sentinel's operational tooling — Set 12E (GA certification / evidence gates),
Set 13E (migration orchestrator), Set 14E (stateful upgrade manager),
Set 15E (fleet rollout + canary controller) — and in-tree KVM FC/CH parity
