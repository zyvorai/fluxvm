...
1. S2 production still prefers a real second k8s CNI kubeconfig (`FLUXVM_SECOND_CNI_KUBECONFIG`); portable default re-proven 2026-09-26 — [benchmarks/evidence/sc-live-cni-churn-20260926.txt](benchmarks/evidence/sc-live-cni-churn-20260926.txt) + [sc-live-s2-second-cni-20260926.txt](benchmarks/evidence/sc-live-s2-second-cni-20260926.txt) (nftables stand-in). Indexed in [sc-hotcake-bundle-20260926.txt](benchmarks/evidence/sc-hotcake-bundle-20260926.txt).
2. Live SC matrix + day-0 wow: [sc-live-wow-demo-20260926.txt](benchmarks/evidence/sc-live-wow-demo-20260926.txt) (`WOW DEMO: OK`, k8s + k8s-multi); full phase finish [sc-live-phases-summary-20260926.txt](benchmarks/evidence/sc-live-phases-summary-20260926.txt) (`pass=7 skip=3 fail=0`). Adoption packaging: [secure-containers-supported-profile.md](secure-containers-supported-profile.md), [secure-containers-15min-lab.md](secure-containers-15min-lab.md), [sentinel-wedge.md](sentinel-wedge.md).
