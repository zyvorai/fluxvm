...
3. **Optional BPF host routing** — NAT translation followed by FIB redirect when compatible, with non-destructive host-stack fallback (`TC_ACT_OK` after DNAT; soft FIB miss does not drop).
