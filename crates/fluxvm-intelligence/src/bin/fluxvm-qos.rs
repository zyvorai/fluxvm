    ...
    if command == "evaluate" {
        ...
        println!(
            ...
            serde_json::to_string_pretty(
                &serde_json::json!({"assessment":assessment,"applied":applied})
            )?
        );
    }
    Ok(())
